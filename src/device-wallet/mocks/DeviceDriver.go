...
func (_m *DeviceDriver) GetDevice() (io.ReadWriteCloser, error) {
	ret := _m.Called()
...
func (_m *DeviceDriver) SendToDevice(dev io.ReadWriteCloser, chunks [][64]byte) (wire.Message, error) {
...
func (_m *DeviceDriver) SendToDeviceNoAnswer(dev io.ReadWriteCloser, chunks [][64]byte) error {
	ret := _m.Called(dev, chunks)
