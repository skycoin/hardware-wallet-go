...
func (_m *Devicer) AddressGen(addressN int, startIndex int, confirmAddress bool) (wire.Message, error) {
...
func (_m *Devicer) ApplySettings(usePassphrase bool, label string) (wire.Message, error) {
...
func (_m *Devicer) ChangePin() (wire.Message, error) {
	ret := _m.Called()
...
func (_m *Devicer) SignMessage(addressN int, message string) (wire.Message, error) {
...
func (_m *Devicer) TransactionSign(inputs []*messages.SkycoinTransactionInput, outputs []*messages.SkycoinTransactionOutput) (wire.Message, error) {
